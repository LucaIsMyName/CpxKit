...
export class ComponentRoot extends Cpx.Element {
    ...
    constructor() {
        ...
        this.title =
            this.getAttribute('root:title')
            || 'Root Title';

        this.description =
            this.getAttribute('root:description')
            || 'Root Description';
    ...
    render() {
        ...
        <section class="root">
            ...
            <main class="root__main">
                ${this.state.has('page')
                ? `<app-page-${this.state.get('page')} class="root__page"></app-page-${this.state.get('page')}>`
            ...
            <app-modal
                class="
                    root__modal 
                    ${eval(this.state.get('modalIsActive')) === true 
                        ? 'root__modal--is-active' 
                        : ''
                    }
                "
                ...
                ? `<app-page-${this.state.get('modalContent')} class="root__modal-content"></app-page-${this.state.get('modalContent')}>`
                : ``
            }
